"""
data_manager.py  —  HuggingFace data loader for Epsilon-Dominance Engine
========================================================================
"""
...
def load_master_data(hf_token: Optional[str] = None) -> Tuple[pd.DataFrame, pd.DataFrame]:
    ...
    parquet_path = None
    for fname in ["master_data.parquet", "data/master.parquet", "master.parquet", "fi_etf_macro_master.parquet"]:
        try:
